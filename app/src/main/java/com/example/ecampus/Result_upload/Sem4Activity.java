...
public class Sem4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        student_data = database.getReference("Sem 4");
            ...
            public void onClick(View v) {
                ...
                student_data.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            StudentData4 studentData = new StudentData4(stenroll, stsubone, stsubtwo, stsubthree, stsubfour,stsubfive, stsubsix, stsubseven);
                            student_data.child(stenroll).setValue(studentData);
                            Toast.makeText(Sem4Activity.this,"Result is uploaded.",Toast.LENGTH_SHORT).show();
