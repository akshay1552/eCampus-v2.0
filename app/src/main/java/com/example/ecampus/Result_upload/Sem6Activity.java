...
public class Sem6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        student_data = database.getReference("Sem 6");
            ...
            public void onClick(View v) {
                ...
                student_data.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            StudentData6 studentData = new StudentData6(stenroll, stsubone, stsubtwo, stsubthree, stsubfour,stsubfive, stsubsix, stsubseven);
                            student_data.child(stenroll).setValue(studentData);
                            Toast.makeText(Sem6Activity.this,"Result is uploaded.",Toast.LENGTH_SHORT).show();
