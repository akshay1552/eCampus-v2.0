...
public class Sem5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        student_data = database.getReference("Sem 5");
            ...
            public void onClick(View v) {
                ...
                student_data.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            StudentData5 studentData = new StudentData5(stenroll, stsubone, stsubtwo, stsubthree, stsubfour,stsubfive, stsubsix, stsubseven);
                            student_data.child(stenroll).setValue(studentData);
                            Toast.makeText(Sem5Activity.this,"Result is uploaded.",Toast.LENGTH_SHORT).show();
