...
public class Sem1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        student_data = database.getReference("Sem 1");
            ...
            public void onClick(View v) {
                ...
                student_data.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        {
                            StudentData studentData = new StudentData(stenroll, stsubone, stsubtwo, stsubthree, stsubfour, stsubsix, stsubseven);
                            student_data.child(stenroll).setValue(studentData);
                            Toast.makeText(Sem1Activity.this,"Result is uploaded.",Toast.LENGTH_SHORT).show();
