...
public class StCourse5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_st_course5);
        ...
        btn_uploadData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                course_data5.addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                        CourseData5 courseData5 = new CourseData5(stenroll, stcourseone, stcoursetwo, stcoursethree, stcoursefour, stcoursefive, stcoursesix);
                        course_data5.child(stenroll).setValue(courseData5);
                        Toast.makeText(StCourse5Activity.this, "Course Registered.",Toast.LENGTH_SHORT).show();
