...
public class Results4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show_data = database.getReference("Sem 4");
            ...
            public void onClick(View v) {
                ...
                show_data.child(number).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        StudentData4 studentData = dataSnapshot.getValue(StudentData4.class);
                        enrollno.setText(studentData.getStudent_Enroll_No());
                        subone.setText(studentData.getSoftware_Engg());
                        subtwo.setText(studentData.getOOMD());
                        subthree.setText(studentData.getComputer_Network());
                        subfour.setText(studentData.getJava());
                        subfive.setText(studentData.getMicroprocessor());
                        subsix.setText(studentData.getAdvance_Web_Page_Design());
                        subseven.setText(studentData.getEDP());
